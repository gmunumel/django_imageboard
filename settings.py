...
PROJECT_DIR = os.path.join(BASE_DIR, 'imageboard')
...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_imageboard',                         # Or path to database file if using sqlite3.
...
SECRET_KEY = '3yskve2ye5x)s-dv!__2=3$_f)*tf&amp;(25o0!iv$-2gk7vn5x-u'
...
DATABASES['django_imageboard'] =  dj_database_url.config()
...
MY_STATIC_ROOT = os.path.join(PROJECT_DIR, 'static/')

# Absolute filesystem path to the directory that will hold user-uploaded files.
# Example: "/home/media/media.lawrence.com/media/"
MEDIA_ROOT = os.path.join(MY_STATIC_ROOT, 'media/')
